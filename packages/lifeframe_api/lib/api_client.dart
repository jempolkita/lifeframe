    ...
    try {
      switch (targetType) {
        ...
        case 'DeviceStatusResponse':
          return DeviceStatusResponse.fromJson(value);
        case 'ErrorResponse':
          return ErrorResponse.fromJson(value);
        case 'ExifData':
          return ExifData.fromJson(value);
        case 'FaceTag':
          return FaceTag.fromJson(value);
        case 'GeoLocation':
          return GeoLocation.fromJson(value);
        case 'Person':
          return Person.fromJson(value);
        case 'Photo':
          return Photo.fromJson(value);
        case 'SyncManifest':
          return SyncManifest.fromJson(value);
        case 'UploadResponse':
