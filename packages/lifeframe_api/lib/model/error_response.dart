...
class ErrorResponse {
  ...
  static ErrorResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'code'), 'Required key "ErrorResponse[code]" is missing from JSON.');
        assert(json[r'code'] != null, 'Required key "ErrorResponse[code]" has a null value in JSON.');
